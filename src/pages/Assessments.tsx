...
const assessments = [
  ...
  },
  {
    ...
    description: "Evaluate your understanding of closures, promises, and ES6+ features.",
    questions: 30,
    duration: "45 min",
    difficulty: "Intermediate",
    status: "completed",
  ...
  },
  {
    ...
    description: "Evaluate your understanding of scalability, databases, and architecture.",
    questions: 15,
    duration: "40 min",
    difficulty: "Advanced",
    status: "locked",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Continuous evaluation of your skills with actionable feedback and personalized recommendations.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            { icon: ClipboardCheck, label: "Tests Completed", value: "12", color: "text-success" },
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h2 className="font-heading text-2xl font-semibold">Available Assessments</h2>
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        assessment.status === "completed" ? "bg-success/20 text-success" :
                        assessment.status === "locked" ? "bg-muted text-muted-foreground" :
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-xs px-2 py-0.5 rounded-full ${
                            assessment.difficulty === "Beginner" ? "bg-success/20 text-success" :
                            assessment.difficulty === "Intermediate" ? "bg-warning/20 text-warning" :
                        ...
                        <h3 className="font-heading font-semibold text-lg">{assessment.title}</h3>
                    ...
                    <Button 
                      variant={
                        ...
                        assessment.status === "locked" ? "secondary" : 
                        "gradient"
                      }
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-sm text-primary-foreground/80 mb-4">
                Based on your assessments, focus on improving your backend skills. 
                Try the Node.js learning path!
              </p>
